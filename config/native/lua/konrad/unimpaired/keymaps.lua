...
vim.keymap.set("n", "[<C-l>", funs.lpfile, funs.opts_with_desc("jump to last entry of previous file in loclist"))
vim.keymap.set("n", "]<C-l>", funs.lnfile, funs.opts_with_desc("jump to first entry of next file in loclist"))
...
vim.keymap.set("n", "[<C-q>", funs.cpfile, funs.opts_with_desc("jump to last entry of previous file in qflist"))
vim.keymap.set("n", "]<C-q>", funs.cnfile, funs.opts_with_desc("jump to first entry of next file in qflist"))
...
vim.keymap.set("n", "[<C-t>", funs.ptprevious, funs.opts_with_desc(":tprevious in the preview window"))
vim.keymap.set("n", "]<C-t>", funs.ptnext, funs.opts_with_desc(":tnext in the preview window"))

vim.keymap.set("n", "[f", funs.previous_file, funs.opts_with_desc("Previous file in directory. :colder in qflist"))
vim.keymap.set("n", "]f", funs.next_file, funs.opts_with_desc("Next file in directory. :cnewer in qflist"))
