...
-- movement
vim.keymap.set("n", "<leader>q", funs.toggle_qflist, opts_with_desc("Toggle Quickfix List"))
vim.keymap.set("n", "<leader>l", funs.toggle_llist, opts_with_desc("Toggle Local List"))

vim.keymap.set("n", "[f", funs.previous_file, opts_with_desc("Previous file in directory"))
vim.keymap.set("n", "]f", funs.next_file, opts_with_desc("Next file in directory"))
