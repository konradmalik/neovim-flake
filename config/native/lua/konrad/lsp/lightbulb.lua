...
local icon = ""
local highlight = "Normal:CursorLineNr"
...
--- (probably can be simplified once this is resolved: https://github.com/neovim/neovim/issues/21985)
---@param bufnr integer
---@param winnr integer
---@return lsp.Diagnostic[] A table of LSP Diagnostic
