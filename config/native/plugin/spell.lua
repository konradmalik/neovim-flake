local spellfile_path = function()
	...
	if vim.fn.isdirectory(repo) == 0 then return vim.fn.stdpath("config") .. "/spell/en.utf-8.add" end
...
vim.api.nvim_create_user_command("MkSpell", function() vim.cmd("mkspell! " .. spellfile_path()) end, {
