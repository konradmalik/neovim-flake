...
M.previous = function() vim.cmd("silent! " .. vim.v.count1 .. "previous") end

M.next = function() vim.cmd("silent! " .. vim.v.count1 .. "next") end

M.first = function() vim.cmd("first") end

M.last = function() vim.cmd("last") end

M.bprevious = function() vim.cmd(vim.v.count1 .. "bprevious") end

M.bnext = function() vim.cmd(vim.v.count1 .. "bnext") end

M.bfirst = function() vim.cmd("bfirst") end

M.blast = function() vim.cmd("blast") end
...
M.lfirst = function() vim.cmd("lfirst") end

M.llast = function() vim.cmd("llast") end

M.lpfile = function() vim.cmd("silent! " .. vim.v.count1 .. "lpfile") end

M.lnfile = function() vim.cmd("silent! " .. vim.v.count1 .. "lnfile") end
...
M.cfirst = function() vim.cmd("cfirst") end

M.clast = function() vim.cmd("clast") end

M.cpfile = function() vim.cmd("silent! " .. vim.v.count1 .. "cpfile") end

M.cnfile = function() vim.cmd("silent! " .. vim.v.count1 .. "cnfile") end

M.tprevious = function() vim.cmd("silent! " .. vim.v.count1 .. "tprevious") end

M.tnext = function() vim.cmd("silent! " .. vim.v.count1 .. "tnext") end

M.tfirst = function() vim.cmd("tfirst") end

M.tlast = function() vim.cmd("tlast") end

M.ptprevious = function() vim.cmd("silent! " .. vim.v.count1 .. "ptprevious") end

M.ptnext = function() vim.cmd("silent! " .. vim.v.count1 .. "ptnext") end
